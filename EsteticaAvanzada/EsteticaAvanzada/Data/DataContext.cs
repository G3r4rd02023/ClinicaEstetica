...
namespace EsteticaAvanzada.Data
{
    public class DataContext : DbContext
    {
        ...
        public DbSet<DepilacionLaser> DepilacionLaser { get; set; }
        ...
        public DbSet<HistoriaNutricional> HistoriaNutricional { get; set; }
        ...
        public DbSet<TratamientoCapilar> TratamientoCapilar { get; set; }
